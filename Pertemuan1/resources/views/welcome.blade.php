...
<body class="grid">
  <div class="ktp-wrapper rounded-xl place-self-center px-10 py-3 border-2">
    <div class="header-wrapper grid place-items-center">
      ...
      <div class="province">KABUPATEN KLATEN</div>
    </div>
    <div class="body-wrapper mt-2 flex gap-[2rem]">
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td class="ps-1 font-semibold text-lg">620701XXXXXXXXXXX</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Nama <span>:</span>
              </td>
              <td class="ps-1 text-sm uppercase">MUHAMMAD ANDIKA SATRIO WIBOWO</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Tempat/Tgl Lahir <span>:</span>
              </td>
              <td class="ps-1 text-sm">KLATEN, 03-10-2002</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
              ...
              <td class="ps-1 text-sm">O</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Alamat <span>:</span>
              </td>
              <td class="ps-1 text-sm">PASON, CEPER, CEPER, KLATEN</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                <span class="ms-9">RT/RW</span> <span>:</span>
              </td>
              <td class="ps-1 text-sm">002/008</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                <span class="ms-9">Kel/Desa</span> <span>:</span>
              </td>
              <td class="ps-1 text-sm">KEBOAN PASON</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                <span class="ms-9">KECAMATAN</span> <span>:</span>
              </td>
              <td class="ps-1 text-sm">CEPER</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Agama <span>:</span>
      ...
      <div class="left-content grid">
        <div class="image-wrapper w-full">
          <img src="{{asset('../img/profil.jpeg')}}" class=" object-cover h-full w-40 rounded" />
        </div>
        <div class="created-at text-center">
          <div class="region text-sm font-semibold mt-1">KLATEN</div>
          <div class="region text-sm">14-01-2020</div>
        </div>
      </div>
    </div>
